...
public class PlotService {
	...
	public synchronized JsonNode getPlotData(String zone, String attribute) {
	...
	public synchronized void update() {
		...
		for (String zone : zones) {
			...
			try {
				...
				System.out.println("Exception when reading zone '" + zone + "'. Skipping.");
				e.printStackTrace();
			...
			// remove old elements
			for (String attr : new LinkedList<>(attrMap.keySet())) {
